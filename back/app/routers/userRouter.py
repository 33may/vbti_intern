...
from app.services.userService import fetch_users, fetch_user
...
async def get_projects_by_user_id(user_id: int, current_user_token: TokenData = Depends(get_current_admin_user)) -> List[ProjectGet]:
    try:
